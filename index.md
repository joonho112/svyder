...
runs the three-step **compute → classify → correct** pipeline in one
call.
...
![](reference/figures/README-profile-1.png)
...
- Closed-form **decomposition**
  ...
  linking DER to the Kish design effect and hierarchical shrinkage.
- Works from a plain draws matrix or directly from **brms**,
  **cmdstanr**, **rstanarm**, and the **survey** package.
- broom-style [`tidy()`](https://generics.r-lib.org/reference/tidy.html)
  / [`glance()`](https://generics.r-lib.org/reference/glance.html) and
  profile / decomposition / comparison plots.
...
| Backend | [`der_compute()`](https://joonho112.github.io/svyder/reference/der_compute.md) method | Auto-extracts |
|----|----|----|
| draws matrix | [`der_compute.matrix()`](https://joonho112.github.io/svyder/reference/der_compute.md) | — (you supply everything) |
| brms | [`der_compute.brmsfit()`](https://joonho112.github.io/svyder/reference/der_compute.md) | `y`, `X`, `group`, `family`, `sigma_theta` |
| cmdstanr | [`der_compute.CmdStanMCMC()`](https://joonho112.github.io/svyder/reference/der_compute.md) | draws only (you supply the data) |
| rstanarm | [`der_compute.stanreg()`](https://joonho112.github.io/svyder/reference/der_compute.md) | `y`, `X`, `group`, `family`, `sigma_theta` |
| survey | [`extract_design()`](https://joonho112.github.io/svyder/reference/extract_design.md) | `weights`, `cluster`, `strata` |
